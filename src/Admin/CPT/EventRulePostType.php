...
class EventRulePostType {
    ...
    public function register_meta_fields() {
        // Event Type
        register_post_meta( self::POST_TYPE, '_event_type', array(
            'type'         => 'string',
            'single'       => true,
            'show_in_rest' => true,
            'default'      => '',
        ...
        // Site Location
        register_post_meta( self::POST_TYPE, '_site_location', array(
            'type'         => 'string',
            'single'       => true,
            'show_in_rest' => true,
            'default'      => 'all_pages',
        ...
        // Event Trigger Delay
        register_post_meta( self::POST_TYPE, '_trigger_delay', array(
            'type'         => 'number',
            'single'       => true,
            'show_in_rest' => true,
            'default'      => 0,
        ...
        // Stop Propagation
        register_post_meta( self::POST_TYPE, '_stop_propagation', array(
            'type'         => 'boolean',
            'single'       => true,
            'show_in_rest' => true,
            'default'      => false,
        ...
        register_post_meta( self::POST_TYPE, '_parent_selector', array(
            'type'         => 'string',
            'single'       => true,
            'show_in_rest' => true,
            'default'      => '',
        ...
        register_post_meta( self::POST_TYPE, '_multiple_toggle', array(
            'type'         => 'boolean',
            'single'       => true,
            'show_in_rest' => true,
            'default'      => false,
        ...
        register_post_meta( self::POST_TYPE, '_child_selectors', array(
            'type'         => 'string',
            'single'       => true,
            'show_in_rest' => false,
            'default'      => '',
        ...
        register_post_meta( self::POST_TYPE, '_parameters', array(
            'type'         => 'string',
            'single'       => true,
            'show_in_rest' => false,
            'default'      => '',
