...
$eventlayer_logo_url   = \EventLayer\Plugin::get_instance()->get_plugin_url(
	'src/Assets/images/eventlayerpro_logo.png'
);
$eventlayer_intro_text = __(
	'EventLayer allows you to create custom DataLayer events for Google Analytics 4 and Google Tag Manager.',
	'eventlayer'
);
?>
...
<div class="wrap">
	...
	<div class="eventlayer-hero">
		<div class="eventlayer-hero-logo">
			<img src="<?php echo esc_url( $eventlayer_logo_url ); ?>"
				alt="<?php esc_attr_e( 'EventLayer Pro', 'eventlayer' ); ?>" />
		</div>
	</div>
	...
	<div class="eventlayer-admin-content">
		<div class="postbox">
			<div class="inside">
				...
				<p><?php echo esc_html( $eventlayer_intro_text ); ?></p>
				...
				<ol>
					...
					<li>
						<?php esc_html_e( 'Events will automatically be pushed to window.dataLayer', 'eventlayer' ); ?>
					</li>
				</ol>

				<h3><?php esc_html_e( 'Quick Actions', 'eventlayer' ); ?></h3>
				<p>
					<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=event_rule' ) ); ?>"
					...
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=eventlayer-settings' ) ); ?>"
						class="button">
